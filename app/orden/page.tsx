  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Tu Orden</h1>
                  ...
                  {items.map((item, index) => (
                    <div key={`${item.producto.id}-${item.talla.nombre}`} className="p-6 flex flex-col sm:flex-row">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Talla: {item.talla.nombre}</p>
                        <p className="text-sm text-gray-500">Precio unitario: ${item.talla.precio.toFixed(2)}</p>
